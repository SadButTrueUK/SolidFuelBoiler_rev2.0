...
//#define TIME_CTRL_LS_AFTER_BEGIN				1500U
//#define TIME_CTRL_LS_AFTER_BEGIN				2000U	  //время (мc), по истечении которого при вращении двигателя должен изменить состояние концевик
...
const rom IOport_motor motor_pins_forward[QUANTITY_MOTORS] =
{
	...
	{
        (volatile uint8_t* const)&LATH, 0,		//верхний ключ 1-го полумоста
        (volatile uint8_t* const)&LATG, 4       //нижний ключ 5-го полумоста
    },			
